...
declare function getTestInstance<O extends Partial<BetterAuthOptions>, C extends BetterAuthClientOptions>(options?: O | undefined, config?: {
  ...
  client: UnionToIntersection<(C extends undefined ? {} : C) & {
  ...
  })["plugins"] extends (infer Plugin_1)[] ? UnionToIntersection<Plugin_1 extends _better_auth_core39.BetterAuthClientPlugin ? Plugin_1["getActions"] extends ((...args: any) => infer Actions) ? Actions : {} : {}> : {}) & UnionToIntersection<InferRoute<((C extends undefined ? {} : C) & {
    baseURL: string | undefined;
    fetchOptions: {
      customFetchImpl: (url: string | URL | Request, init?: RequestInit | undefined) => Promise<Response>;
    };
    ...
    useSession: nanostores4.Atom<{
      ...
      error: _better_fetch_fetch95.BetterFetchError | null;
      isPending: boolean;
    ...
    $fetch: _better_fetch_fetch95.BetterFetch<{
      plugins: (_better_fetch_fetch95.BetterFetchPlugin<Record<string, any>> | {
        ...
        hooks: {
          ...
          onRequest: (<T_1 extends Record<string, any>>(context: _better_fetch_fetch95.RequestContext<T_1>) => Promise<_better_fetch_fetch95.RequestContext | void> | _better_fetch_fetch95.RequestContext | void) | undefined;
