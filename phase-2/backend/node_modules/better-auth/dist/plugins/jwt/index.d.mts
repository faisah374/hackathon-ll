...
declare const jwt: <O extends JwtOptions>(options?: O) => {
  ...
  options: NoInfer<O>;
  endpoints: {
    getJwks: better_call232.StrictEndpoint<string, {
      method: "GET";
      metadata: {
        openapi: {
          operationId: string;
    ...
    getToken: better_call232.StrictEndpoint<"/token", {
      method: "GET";
      requireHeaders: true;
      use: ((inputContext: better_call232.MiddlewareInputContext<better_call232.MiddlewareOptions>) => Promise<{
        session: {
    ...
    signJWT: better_call232.StrictEndpoint<string, {
      method: "POST";
      metadata: {
        $Infer: {
          body: {
    ...
    verifyJWT: better_call232.StrictEndpoint<string, {
      method: "POST";
      metadata: {
        $Infer: {
          body: {
