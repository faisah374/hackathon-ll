...
declare const genericOAuth: (options: GenericOAuthOptions) => {
  ...
  endpoints: {
    signInWithOAuth2: better_call227.StrictEndpoint<"/sign-in/oauth2", {
      method: "POST";
    ...
    oAuth2Callback: better_call227.StrictEndpoint<"/oauth2/callback/:providerId", {
      method: "GET";
    ...
    oAuth2LinkAccount: better_call227.StrictEndpoint<"/oauth2/link", {
      method: "POST";
      body: zod486.ZodObject<{
        providerId: zod486.ZodString;
      ...
      use: ((inputContext: better_call227.MiddlewareInputContext<better_call227.MiddlewareOptions>) => Promise<{
        session: {
