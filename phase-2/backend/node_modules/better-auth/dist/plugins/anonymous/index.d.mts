...
declare const anonymous: (options?: AnonymousOptions | undefined) => {
  id: "anonymous";
  endpoints: {
    signInAnonymous: better_call194.StrictEndpoint<"/sign-in/anonymous", {
      method: "POST";
      metadata: {
        openapi: {
          description: string;
    ...
    deleteAnonymousUser: better_call194.StrictEndpoint<"/delete-anonymous-user", {
      method: "POST";
      use: ((inputContext: better_call194.MiddlewareInputContext<better_call194.MiddlewareOptions>) => Promise<{
        session: {
