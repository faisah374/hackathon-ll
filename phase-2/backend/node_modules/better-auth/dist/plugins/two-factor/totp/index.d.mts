...
import * as better_call1006 from "better-call";
...
declare const totp2fa: (options?: TOTPOptions | undefined) => {
  ...
  endpoints: {
     ...
     */
    generateTOTP: better_call1006.StrictEndpoint<string, {
      method: "POST";
      body: z.ZodObject<{
        secret: z.ZodString;
      }, z.core.$strip>;
     ...
     */
    getTOTPURI: better_call1006.StrictEndpoint<"/two-factor/get-totp-uri", {
      method: "POST";
      use: ((inputContext: better_call1006.MiddlewareInputContext<better_call1006.MiddlewareOptions>) => Promise<{
        session: {
     ...
     */
    verifyTOTP: better_call1006.StrictEndpoint<"/two-factor/verify-totp", {
      method: "POST";
      body: z.ZodObject<{
        code: z.ZodString;
