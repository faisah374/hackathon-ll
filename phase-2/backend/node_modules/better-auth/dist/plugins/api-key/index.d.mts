...
import * as better_call268 from "better-call";
...
declare const apiKey: (options?: ApiKeyOptions | undefined) => {
  ...
  hooks: {
    before: {
      ...
      handler: (inputContext: better_call268.MiddlewareInputContext<better_call268.MiddlewareOptions>) => Promise<{
        user: {
          id: string;
          createdAt: Date;
          updatedAt: Date;
        ...
        context: better_call268.MiddlewareContext<better_call268.MiddlewareOptions, {
          ...
          createAuthCookie: (cookieName: string, overrideAttributes?: Partial<better_call268.CookieOptions> | undefined) => _better_auth_core23.BetterAuthCookie;
          secret: string;
          sessionConfig: {
            updateAge: number;
            expiresIn: number;
  ...
  endpoints: {
     ...
     */
    createApiKey: better_call268.StrictEndpoint<"/api-key/create", {
      method: "POST";
      body: zod522.ZodObject<{
        name: zod522.ZodOptional<zod522.ZodString>;
        expiresIn: zod522.ZodDefault<zod522.ZodNullable<zod522.ZodOptional<zod522.ZodNumber>>>;
        userId: zod522.ZodOptional<zod522.ZodCoercedString<unknown>>;
        prefix: zod522.ZodOptional<zod522.ZodString>;
        remaining: zod522.ZodDefault<zod522.ZodNullable<zod522.ZodOptional<zod522.ZodNumber>>>;
        metadata: zod522.ZodOptional<zod522.ZodAny>;
        refillAmount: zod522.ZodOptional<zod522.ZodNumber>;
        refillInterval: zod522.ZodOptional<zod522.ZodNumber>;
        rateLimitTimeWindow: zod522.ZodOptional<zod522.ZodNumber>;
        rateLimitMax: zod522.ZodOptional<zod522.ZodNumber>;
        rateLimitEnabled: zod522.ZodOptional<zod522.ZodBoolean>;
        permissions: zod522.ZodOptional<zod522.ZodRecord<zod522.ZodString, zod522.ZodArray<zod522.ZodString>>>;
      }, zod_v4_core77.$strip>;
      metadata: {
        openapi: {
          description: string;
     ...
     */
    verifyApiKey: better_call268.StrictEndpoint<string, {
      method: "POST";
      body: zod522.ZodObject<{
        key: zod522.ZodString;
        permissions: zod522.ZodOptional<zod522.ZodRecord<zod522.ZodString, zod522.ZodArray<zod522.ZodString>>>;
      }, zod_v4_core77.$strip>;
    }, {
      valid: boolean;
     ...
     */
    getApiKey: better_call268.StrictEndpoint<"/api-key/get", {
      method: "GET";
      query: zod522.ZodObject<{
        id: zod522.ZodString;
      }, zod_v4_core77.$strip>;
      use: ((inputContext: better_call268.MiddlewareInputContext<better_call268.MiddlewareOptions>) => Promise<{
        session: {
     ...
     */
    updateApiKey: better_call268.StrictEndpoint<"/api-key/update", {
      method: "POST";
      body: zod522.ZodObject<{
        keyId: zod522.ZodString;
        userId: zod522.ZodOptional<zod522.ZodCoercedString<unknown>>;
        name: zod522.ZodOptional<zod522.ZodString>;
        enabled: zod522.ZodOptional<zod522.ZodBoolean>;
        remaining: zod522.ZodOptional<zod522.ZodNumber>;
        refillAmount: zod522.ZodOptional<zod522.ZodNumber>;
        refillInterval: zod522.ZodOptional<zod522.ZodNumber>;
        metadata: zod522.ZodOptional<zod522.ZodAny>;
        expiresIn: zod522.ZodNullable<zod522.ZodOptional<zod522.ZodNumber>>;
        rateLimitEnabled: zod522.ZodOptional<zod522.ZodBoolean>;
        rateLimitTimeWindow: zod522.ZodOptional<zod522.ZodNumber>;
        rateLimitMax: zod522.ZodOptional<zod522.ZodNumber>;
        permissions: zod522.ZodNullable<zod522.ZodOptional<zod522.ZodRecord<zod522.ZodString, zod522.ZodArray<zod522.ZodString>>>>;
      }, zod_v4_core77.$strip>;
      metadata: {
        openapi: {
          description: string;
     ...
     */
    deleteApiKey: better_call268.StrictEndpoint<"/api-key/delete", {
      method: "POST";
      body: zod522.ZodObject<{
        keyId: zod522.ZodString;
      }, zod_v4_core77.$strip>;
     ...
     */
    listApiKeys: better_call268.StrictEndpoint<"/api-key/list", {
      method: "GET";
      use: ((inputContext: better_call268.MiddlewareInputContext<better_call268.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
     ...
     */
    deleteAllExpiredApiKeys: better_call268.StrictEndpoint<string, {
      method: "POST";
    }, {
      success: boolean;
      error: unknown;
