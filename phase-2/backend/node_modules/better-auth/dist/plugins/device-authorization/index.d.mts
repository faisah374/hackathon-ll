...
declare const deviceAuthorization: (options?: Partial<DeviceAuthorizationOptions>) => {
  ...
  endpoints: {
    deviceCode: better_call243.StrictEndpoint<"/device/code", {
      method: "POST";
      body: z.ZodObject<{
    ...
    deviceToken: better_call243.StrictEndpoint<"/device/token", {
      method: "POST";
      body: z.ZodObject<{
    ...
    deviceVerify: better_call243.StrictEndpoint<"/device", {
      method: "GET";
      query: z.ZodObject<{
    ...
    deviceApprove: better_call243.StrictEndpoint<"/device/approve", {
      method: "POST";
      body: z.ZodObject<{
    ...
    deviceDeny: better_call243.StrictEndpoint<"/device/deny", {
      method: "POST";
      body: z.ZodObject<{
        userCode: z.ZodString;
      }, z.core.$strip>;
