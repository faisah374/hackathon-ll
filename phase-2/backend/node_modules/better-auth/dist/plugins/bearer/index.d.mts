...
declare const bearer: (options?: BearerOptions | undefined) => {
  ...
  hooks: {
    before: {
      ...
      handler: (inputContext: better_call200.MiddlewareInputContext<better_call200.MiddlewareOptions>) => Promise<{
        context: {
          headers: Headers;
        };
      } | undefined>;
    ...
    after: {
      matcher(context: _better_auth_core9.HookEndpointContext): true;
      handler: (inputContext: better_call200.MiddlewareInputContext<better_call200.MiddlewareOptions>) => Promise<void>;
    }[];
  };
