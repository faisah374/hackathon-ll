...
declare const emailOTP: (options: EmailOTPOptions) => {
  ...
  endpoints: {
    sendVerificationOTP: better_call175.StrictEndpoint<"/email-otp/send-verification-otp", {
      method: "POST";
    ...
    createVerificationOTP: better_call175.StrictEndpoint<string, {
      method: "POST";
      body: zod441.ZodObject<{
        email: zod441.ZodString;
        type: zod441.ZodEnum<{
    ...
    getVerificationOTP: better_call175.StrictEndpoint<string, {
      method: "GET";
    ...
    checkVerificationOTP: better_call175.StrictEndpoint<"/email-otp/check-verification-otp", {
      method: "POST";
      body: zod441.ZodObject<{
        email: zod441.ZodString;
        type: zod441.ZodEnum<{
    ...
    verifyEmailOTP: better_call175.StrictEndpoint<"/email-otp/verify-email", {
      method: "POST";
      body: zod441.ZodObject<{
        email: zod441.ZodString;
        otp: zod441.ZodString;
    ...
    signInEmailOTP: better_call175.StrictEndpoint<"/sign-in/email-otp", {
      method: "POST";
      body: zod441.ZodObject<{
        email: zod441.ZodString;
        otp: zod441.ZodString;
    ...
    forgetPasswordEmailOTP: better_call175.StrictEndpoint<"/forget-password/email-otp", {
      method: "POST";
      body: zod441.ZodObject<{
        email: zod441.ZodString;
      }, zod_v4_core61.$strip>;
    ...
    resetPasswordEmailOTP: better_call175.StrictEndpoint<"/email-otp/reset-password", {
      method: "POST";
      body: zod441.ZodObject<{
        email: zod441.ZodString;
        otp: zod441.ZodString;
