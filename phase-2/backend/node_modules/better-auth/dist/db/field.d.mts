...
declare const createFieldAttribute: <T extends DBFieldType, C extends DBFieldAttributeConfig>(type: T, config?: C | undefined) => {
  ...
  defaultValue?: (_better_auth_core_db14.DBPrimitive | (() => _better_auth_core_db14.DBPrimitive)) | undefined;
  onUpdate?: (() => _better_auth_core_db14.DBPrimitive) | undefined;
  transform?: {
    input?: (value: _better_auth_core_db14.DBPrimitive) => _better_auth_core35.Awaitable<_better_auth_core_db14.DBPrimitive>;
    output?: (value: _better_auth_core_db14.DBPrimitive) => _better_auth_core35.Awaitable<_better_auth_core_db14.DBPrimitive>;
  } | undefined;
  references?: {
    model: string;
    field: string;
