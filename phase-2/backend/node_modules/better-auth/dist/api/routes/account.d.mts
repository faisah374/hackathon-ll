...
import * as better_call803 from "better-call";

//#region src/api/routes/account.d.ts
declare const listUserAccounts: better_call803.StrictEndpoint<"/list-accounts", {
  method: "GET";
  use: ((inputContext: better_call803.MiddlewareInputContext<better_call803.MiddlewareOptions>) => Promise<{
    session: {
...
declare const linkSocialAccount: better_call803.StrictEndpoint<"/link-social", {
  method: "POST";
  requireHeaders: true;
  body: z.ZodObject<{
...
declare const unlinkAccount: better_call803.StrictEndpoint<"/unlink-account", {
  method: "POST";
  body: z.ZodObject<{
...
declare const getAccessToken: better_call803.StrictEndpoint<"/get-access-token", {
  method: "POST";
  body: z.ZodObject<{
    providerId: z.ZodString;
    accountId: z.ZodOptional<z.ZodString>;
...
declare const refreshToken: better_call803.StrictEndpoint<"/refresh-token", {
  method: "POST";
  body: z.ZodObject<{
    providerId: z.ZodString;
    accountId: z.ZodOptional<z.ZodString>;
...
declare const accountInfo: better_call803.StrictEndpoint<"/account-info", {
  method: "GET";
  use: ((inputContext: better_call803.MiddlewareInputContext<better_call803.MiddlewareOptions>) => Promise<{
    session: {
      session: Record<string, any> & {
