...
declare const signInSocial: <O extends BetterAuthOptions>() => better_call799.StrictEndpoint<"/sign-in/social", {
  method: "POST";
  operationId: string;
  body: z.ZodObject<{
    callbackURL: z.ZodOptional<z.ZodString>;
...
declare const signInEmail: <O extends BetterAuthOptions>() => better_call799.StrictEndpoint<"/sign-in/email", {
  method: "POST";
  operationId: string;
  use: ((inputContext: better_call799.MiddlewareInputContext<better_call799.MiddlewareOptions>) => Promise<void>)[];
  body: z.ZodObject<{
    email: z.ZodString;
